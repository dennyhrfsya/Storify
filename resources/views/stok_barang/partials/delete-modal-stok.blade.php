<div class="modal fade" id="deleteStokModal{{ $stok->id }}" tabindex="-1" role="dialog"
    aria-labelledby="deleteStokLabel{{ $stok->id }}" aria-modal="true">
