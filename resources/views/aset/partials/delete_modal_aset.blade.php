<div class="modal fade" id="deleteAsetModal{{ $aset->id }}" tabindex="-1" role="dialog"
    aria-labelledby="deleteAsetLabel{{ $aset->id }}" aria-modal="true">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="dx-modal-footer">
                    ...
                    <form method="POST" action="{{ route('aset.hapus', $aset->id) }}">
                        @csrf
                        @method('DELETE')
