    ...
    <main>
        <div class="dx-container justify-content-center align-items-center dx-vh">
            <div class="text-center">
                <img src="{{ asset('images/403_forbidden.png') }}" alt="forbidden" class="img-fluid w-75">
                <p class="dx-mt-5">Anda tidak memiliki hak akses untuk {{ $action }} {{ $module }}.
                    <a href="{{ route('dashboard') }}" class="dx-text-sm dx-font-bold dx-text-biru">Halaman
                        Utama</a>
                </p>
            </div>
        </div>
