<div class="modal fade" id="deleteTransaksiModal{{ $transaksi->id }}" tabindex="-1" role="dialog"
    aria-labelledby="deleteTransaksiLabel{{ $transaksi->id }}" aria-modal="true">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="dx-modal-footer">
                    ...
                    <form method="POST" action="{{ route('transaksi.hapus', $transaksi->id) }}">
                        @csrf
                        @method('DELETE')
