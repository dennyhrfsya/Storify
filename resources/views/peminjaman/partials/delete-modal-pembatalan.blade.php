@foreach ($peminjamans as $peminjaman)
    <div class="modal fade" id="deletePeminjamanModal{{ $peminjaman->id }}" tabindex="-1" role="dialog"
        aria-labelledby="deletePeminjamanLabel" aria-modal="true" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="dx-modal-footer">
                        ...
                        <form method="POST" action="{{ route('peminjaman.batalkan', $peminjaman->id) }}">
                            @csrf
                            @method('PUT')
